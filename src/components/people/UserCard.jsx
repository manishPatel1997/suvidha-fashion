        ...
        <Card className={cn("w-full border border-[#dcccbd] rounded-[10px] bg-white overflow-hidden shadow-none flex flex-col py-0 gap-0", className)}>
            ...
            <div className="px-5 py-4 flex-1 space-y-3">
                <div className="grid grid-cols-[80px_1fr] gap-2 items-baseline">
                    <span className="text-[14px] text-[#B0826A] font-medium">Id</span>
                    <span className="text-[14px] text-primary-foreground font-semibold truncate">{user_id || id}</span>
                </div>
                ...
                <div className="grid grid-cols-[80px_1fr] gap-2 items-baseline border-t border-[#dcccbd]/30 pt-3">
                    <span className="text-[14px] text-[#B0826A] font-medium">Mail</span>
                    <span className="text-[14px] text-primary-foreground font-semibold truncate">{email}</span>
                </div>

                <div className="grid grid-cols-[80px_1fr] gap-2 items-baseline border-t border-[#dcccbd]/30 pt-3">
                    <span className="text-[14px] text-[#B0826A] font-medium">Password</span>
                    <span className="text-[14px] text-primary-foreground font-semibold tracking-widest truncate">••••••</span>
                </div>
            </div>
