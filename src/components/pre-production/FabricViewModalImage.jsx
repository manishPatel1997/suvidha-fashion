...
export function FabricViewModalImage({ onOpenChange, open }) {
                    ...
                    <div className="w-full md:w-[55%] space-y-6">
                        ...
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <FloatingInput label="Fabric Id" defaultValue="F-1550" />
                            </div>
                            <div className="flex-1">
                                <FloatingInput label="Fabric" defaultValue="Cotton Fabric" hasEdit />
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <FloatingInput label="Fabric Quality" defaultValue="Permium" hasEdit />
                            </div>
                            <div className="flex-1">
                                <FloatingInput label="Fabric Price" defaultValue="₹ 200 Meter" />
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="flex-1">
                            ...
                            <div className="flex-1">
                                <FloatingInput label="Fabric Meter" defaultValue="3.5 Meter" />
                            </div>
                        </div>
