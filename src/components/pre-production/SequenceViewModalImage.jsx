...
export function SequenceViewModalImage({ onOpenChange, open }) {
                    ...
                    <div className="w-full md:w-[55%] space-y-6">
                        ...
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <FloatingInput label="Sequence Id" defaultValue="Y-1550" />
                            </div>
                            <div className="flex-1">
                                <FloatingInput label="Sequence" defaultValue="Cotton Yarn" hasEdit />
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <div className="flex-1">
                                <FloatingInput label="Sequence CD" defaultValue="40/1" hasEdit />
                            </div>
                            <div className="flex-1">
                                <FloatingInput label="Sequence Price" defaultValue="₹ 200 Meter" />
                            </div>
                        </div>

                        <FloatingInput
                            label="Sequence Vendor"
